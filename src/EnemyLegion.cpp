...
EnemyLegion::EnemyLegion(sf::Vector2f position, int maxHp,
                         double speed, std::array<std::shared_ptr<EnemyLegionSlave>, LEGION_SIZE>* slv) : Enemy("res/orb.png", position, maxHp, speed){
...
void EnemyLegionSlave::_whenAttacking(){
  ...
  setYVelocity(0);
  if(!hasAttacked){
    _currentAnimation = Animation({"res/anim0.png", "res/anim1.png", "res/anim2.png", "res/anim1.png", "res/anim0.png"}, false, 10);
    _isAnimating = true;
    auto attackAnimation = Animation({"res/atk0.png", "res/atk1.png", "res/atk2.png", "res/atk3.png", "res/atk4.png"}, false, 30);
